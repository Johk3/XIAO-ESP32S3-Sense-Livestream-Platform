...
static const char* index_simple_html = R"rawliteral(
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <style>
        ...
        img { width: 1600px; height: 1200px; object-fit: contain; }
    </style>
</head>
<body>
    <img id="stream" src="">
    <script>
        window.onload = function() {
            var port = window.location.port ? (parseInt(window.location.port) + 1) : 81;
            document.getElementById('stream').src = window.location.protocol + '//' + window.location.hostname + ':' + port + '/stream';
        };
    </script>
</body>
</html>
...
static esp_err_t index_handler(httpd_req_t *req) {
  ...
  return httpd_resp_send(req, index_simple_html, strlen(index_simple_html));
}
